...
<head>
    ...
    <title>Login Page | Assesment</title>
...
<div class="container">
  <div class="card">
        ...
        <form class="card-form needs-validation" method="POST" action="code.php" novalidate>
            ...
            <button class="card-button" type="submit" name="login">Sign In</button>
            <small class="card-forgot-password"> New user? <a href="register.php">Sign Up</a></small>
            <small class="card-forgot-password">Forgot your passwrod ? <a href="reset.php">Reset Password</a></small>
        </form>
    </div>
</div>
</body>
